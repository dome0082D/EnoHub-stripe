...
const User = mongoose.model('User', new mongoose.Schema({
    ...
    certFiles: { type: Map, of: String, default: {} }, noteDegustazione: { type: String, default: "" },
    regione: { type: String, default: "" }, filosofia: { type: String, default: "" }, 
    storia: { type: String, default: "" }, sito: { type: String, default: "" },
    unlockedContacts: [String], unlocksRemaining: { type: Number, default: 0 },
